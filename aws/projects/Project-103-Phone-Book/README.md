# Project-103 : Phonebook Application (Python Flask) deployed on AWS Application Load Balancer with Auto Scaling and Relational Database Service using AWS Cloudformation
...
```text
103-phonebook-web-application (folder)
|
